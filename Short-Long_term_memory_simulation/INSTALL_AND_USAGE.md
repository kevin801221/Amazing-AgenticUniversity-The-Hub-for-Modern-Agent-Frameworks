...
```
git clone https://github.com/kevin801221/AgenticU-The-Modular-Teaching-Hub-for-Modern-LLM-Agent-Frameworks.git
cd AgenticU-The-Modular-Teaching-Hub-for-Modern-LLM-Agent-Frameworks/Short-Long_term_memory_simulation/philoagents-api
```
